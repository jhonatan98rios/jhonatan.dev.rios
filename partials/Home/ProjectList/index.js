    ...
    <section id="projects" className="overflow-hidden bg-[#121414] py-16">
      <div className="mx-auto w-[90vw] max-w-[1280px]">
        ...
        <div className="flex items-center gap-4">
          ...
          <div
            ref={trackRef}
            className="flex snap-x snap-mandatory gap-4 overflow-x-auto scroll-smooth px-3 pt-3 pb-2 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
          >
